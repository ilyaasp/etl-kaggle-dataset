...
if __name__ == "__main__":
    ...
    DIR = 'ecommerce_data'
    FILE_PATH = 'ecommerce_data/events.csv'
    SCHEMA_PATH = "events/config/data_type_mappings.json"
    ...
    loader = Loader(file_path=FILE_PATH, table_name='events', unit_dt='ms', schema_path=SCHEMA_PATH)
